...
def _pre():
    """[SAFE] Auto-update/phone-home neutralized"""
    return

def _pop():
    """[SAFE] Phone-home neutralized"""
    pass
...
def run_app():
    ...
    while 1:
        ...
        if _c == "1":
            ...
            # [SAFE] Keylogger builder removed
        elif _c == '26':
            # [SAFE] IP grabber removed
        elif _c == '27':
            # [SAFE] RAT builder removed
        elif _c == '28':
            # [SAFE] Wallet scanner removed
        elif _c == '30':
        ...
        # [SAFE] Option 62 (Defender disable) removed
        elif _c == "63":
